...
import { getStats } from "../data-access/get-stats-creator";
  ...
  return (
    <div className="grid gap-6 grid-cols-1 md:grid-cols-3 mb-6">
      ...
      <StatCard
        ...
        value={totalQtdDonations ?? 0} // Corrigido para usar o valor retornado
      />
      ...
      <StatCard
        ...
        value={formatCurrency((totalAmountResult ?? 0) / 100)} // Corrigido para usar o valor retornado e formatar como moeda
      />
